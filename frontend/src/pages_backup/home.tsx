...
import { BirthDetails, ChartPreferences, ChartData, apiClient, UserInfo } from '@/lib/api';
...
function HomePage() {
  ...
  const handleChartGeneration = useCallback(async (
    ...
    try {
      console.log('Generating chart with details:', birthDetails);
      console.log('Chart preferences:', preferences);

      const chartData: ChartData = await apiClient.calculateChart({
